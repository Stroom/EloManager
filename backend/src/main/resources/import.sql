...
insert into game_user (user_id, name) values (1, 'Sander');
insert into game_user (user_id, name) values (2, 'Viljar');
insert into game_user (user_id, name) values (3, 'Uno');

insert into ranking (ranking_id, value, game_game_id, game_user_user_id) values (1, 1200, 1, 1);
insert into ranking (ranking_id, value, game_game_id, game_user_user_id) values (2, 1200, 1, 2);
insert into ranking (ranking_id, value, game_game_id, game_user_user_id) values (3, 1400, 2, 1);
